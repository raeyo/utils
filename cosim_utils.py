...
def convertYCB2SimObject(ycb_root):
...
if __name__=="__main__":
  # convert ycb objects to model file
  # ycb_root = "/home/raeyo/dataset/ycb-tools/models/ycb"
  # convertYCB2SimObject(ycb_root)
  
  # visualize ycb models to scene
  ycb_model_dir = "/home/raeyo/Dropbox/raeyo/workspace/paper/ICRA/UnknownObjectPlacement_ICRA/environment/ycb_models/google_16k"
  model_list = [join(ycb_model_dir, f) for f in listdir(ycb_model_dir) if isfile(join(ycb_model_dir, f))]
